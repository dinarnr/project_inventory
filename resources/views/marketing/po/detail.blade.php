...
<div class="page-wrapper">
                                ...
                                <table id="datable_1" class="table display pb-30">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $no++ }}</td>
                                            <td>
                                                <a href="#" id="" style="font-weight:bold" data-type="text" data-pk="1" data-title="Nama barang">{{ $detail->nama_barang }}</a><br>&nbsp;&nbsp;-
                                            ...
                                            <td> <a href="#" id="" style="font-weight:bold" data-type="text" data-pk="1" data-title="Amount">{{ number_format($detail->amount), 2 }}</a>
                                            </td>
                                        </tr>
                                        @endforeach
                                        <tr class="txt-dark">
    ...
    <div class="pull-right hide-from-printer">
        <a href="{{ route('cetak_pdf', $no_PO)}}"><button type="button" class="btn btn-success btn-icon left-icon">
