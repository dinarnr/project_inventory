								...
								<table id="datable_3" class="table table-bordered display  pb-30">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ url('office/transaksi/detailkeluarinstalasi') }}/{{ $instalasi->no_transaksi }}"><button class="btn btn-primary btn-icon-anim btn-square"><i class="fa fa-info"></i></button></a>
                                                </td>
                                            </tr>
                                            @endforeach
