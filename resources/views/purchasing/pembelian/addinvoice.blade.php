        ...
        <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    <div class="panel panel-default card-view">
                        <div class="panel-heading">
                            <form action="{{ url('purchasing/pembelian/invoice/simpan') }}" method="post"
                                                ...
                                                @foreach ($data_detail as $data_detail)
                                                    <tr>
                                                        ...
                                                        <td style="display:none"><input type="text"
                                                                style="outline:none;border:0;" readonly name="no_peng1[]"
                                                                id="no_peng1" value="{{ $data_detail->no_pengajuan }}">
                                                        </td>
                                                        <td><input type="text" style="outline:none;border:0;" readonly
                                                                name="nama_barang1[]" id="nama_barang1"
                                                                value="{{ $data_detail->namaBarang }}"></td>
                                                        <td><input type="text" style="outline:none;border:0;" readonly
                                                                name="jml_barang1[]" id="jml_barang"
                                                                value="{{ $data_detail->jmlBarang }}"></td>
                                                        <td><input type="text" style="outline:none;border:0;" readonly
                                                                name="hargaEstimasi[]" id="hargaEstimasi"
                                                                value="{{ $data_detail->harga }}"></td>
                                                        <td><input type="text" style="outline:none;border:0;" readonly
                                                                name="keterangan1[]" id="keterangan"
                                                                value="{{ $data_detail->keterangan }}"></td>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left" for="example-email">Supplier <span
                                                    class="help"> </span></label>
                                            <select class="form-control" name="supplier" id="supplier">
                                                @foreach ($supplier as $supp)
                                                    <option value="{{ $supp->nama_supplier }}">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Tanggal beli<span
                                                    class="help"> </span></label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="nama_barang" id="nama_barang" class="form-control">
                                                @foreach ($coba as $coba)
                                                    <option value="{{ $coba->namaBarang }}">{{ $coba->namaBarang }}
                                                    </option>
                                                @endforeach
                                            </select>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control c2" type="number" name="jumlah" id="jumlah">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="control-label mb-10 text-left">Harga</label>
                                            <input class="form-control d2" type="text" name="harga" id="harga">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group" id="total2" name="total" style="display: none;">
                                            ...
                                            <input type="text" id="harga_beli" name="harga_beli" class="form-control b2"
                                                value="">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                ...
                                <div class="col-md-14" style="text-align:right;">
                                    <button type="button" onclick="ambildata()" class="btn btn-success ">Tambah
                                        Data</button>
                                </div>
                                                            ...
                                                            <div class="col-md-8">
                                                                <div class="form-check form-check-inline">
                                                                    <input class="form-check-input" type="radio"
                                                                        name="radioButton" id="inlineRadio1" value="selesai"
                                                                        checked>
                                                                    <label class="form-check-label"
                                                                        for="inlineRadio1">Selesai</label>
                                                                    <input class="form-check-input" type="radio"
                                                                        name="radioButton" id="inlineRadio2"
                                                                        value="belumSelesai">
                                                                    <label class="form-check-label" for="inlineRadio2">Belum
                                                                        Selesai</label>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group" id="alasan1" name="alasan1"
                                                                        hidden>
                                                                        <label
                                                                            class="control-label mb-10 text-left">Alasan</label>
            ...
            <script>
                ...
                $(document).ready(function() {
                    $(".a2, .b2, .c2, .d2").on("keydown keyup", function(event) {
                        var harga = $("#harga").val().split('.').join('');
                        var jumlah = $("#jumlah").val().split('.').join('');
                        var reverse1 = (harga * jumlah).toString().split('').reverse().join('');
                        amount1 = reverse1.match(/\d{1,3}/g);
                        amount1 = amount1.join('.').split('').reverse().join('');
                        $("#totalBeli").val(amount1);
        ...
        @section('scripts')
            ...
            <script type="text/javascript">
                function ambildata() {
                    ...
                    addrow(no_peng, supplier, totalBeli, tgl_beli, nama_barang, harga, jumlah, jenisTransaksi, info, harga_beli,
                        amount);
                }
                var i = 0;

                function addrow(no_peng, supplier, totalBeli, tgl_beli, nama_barang, harga, jumlah, jenisTransaksi, info,
                    harga_beli, amount) {
                    i++;
                    $('#TabelDinamis').append('<tr id="row' + i +
                        '"></td><td><input type="text" style="outline:none;border:0;"  name="nama_barang[]" id="nama_barang" value="' +
                        nama_barang +
                        '"></td><td><input type="text" style="outline:none;border:0;" readonly name="jumlah[]" id="jumlah" value="' +
                        jumlah +
                        '"></td><td><input type="text" style="outline:none;border:0;" readonly name="harga[]" id="harga" value="' +
                        harga +
                        '"></td><td><input type="text" style="outline:none;border:0;" readonly name="totalBeli[]" id="totalBeli" value="' +
                        totalBeli +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="jenisTransaksi[]" id="jenisTransaksi" value="' +
                        jenisTransaksi +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="tgl_beli[]" id="tgl_beli" value="' +
                        tgl_beli +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="no_peng[]" id="no_peng" value="' +
                        no_peng +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="info[]" id="info" value="' +
                        info +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="harga_beli[]" id="harga_beli" value="' +
                        harga_beli +
                        '"></td><td style="display:none;"><input type="text" style="outline:none;border:0;"  name="amount[]" id="amount" value="' +
                        amount +
                        '"><td><input type="text" style="outline:none;border:0;" readonly name="supplier[]" id="supplier" value="' +
                        supplier +
                        '"></td><td><button type="button" id="' + i +
                        '" class="btn btn-danger btn-small remove_row">&times;</button></td></tr>');
                };
