            ...
            <div class="col-sm-12">
                <div class="panel panel-default card-view">
                    <div class="panel-heading">
                        <p>
                            <a href="{{ url('warehouse/instansi/tambah')}}" class="btn btn-success"> Tambah Data</a>
                        </p>
                                        ...
                                        <table id="datable_1" class="table table-bordered display pb-30">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('warehouse/instansi/ubah')}}/{{ $data_int->id_instansi }}"><button class="btn btn-success btn-icon-anim btn-square"><i class="fa fa-edit"></i></button></a>
