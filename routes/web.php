...
Route::group(['middleware' => 'auth', 'cekdivisi:teknisi,warehouse,marketing,admin,purchasing,administrator'], function () {
    ...
    Route::group(['prefix' => 'purchasing/'], function () {
        ...
        Route::get('pembelian/invoice/belum/{no_pengajuan}', [PembelianPurchasingController::class, 'belumselesai']);
    ...
    Route::group(['prefix' => 'office/'], function () {
        ...
        Route::get('/invoice/lunas/detail/{no_pengajuan}', [PembelianOfficeController::class, 'detaillunas']);
        Route::get('/invoice/detailhutang/', [PembelianOfficeController::class, 'hutang']);
